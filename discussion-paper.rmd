...
main$balance_control(
  ...
  notes = "Notes: Table XX describles variables. Columns 2–-8 show sample averages for each experimental arm. Column 9 shows p-value of the joint null hypothesis (F-test)."
)
```
