...
Table \@ref(tab:monetary-value) shows the estimated monetary value of the text message reminders. The second and third columns show their effect on the actual uptake of antibody testing and the baseline vaccination rates plus the reminder effect, respectively. As shown in the fourth column, the Altruistic has monetary values of about JPY 2,000 (about USD 18; 40% of the assumed vaccination cost). The total monetary value is the product of the per capita value and number of people who have not yet used the free vouchers issued in FY2019 ($5.29$ million as of January 2020). As shown in the fifth column, the Altruistic messages are worth JPY 10 billion (about USD 98 million).
