...
#' さらに、彼らの内の一部が風しんに自然感染していないことを反映している[^routine]。
...
#'
#' 1. 2019年度は、40-46歳の男性にクーポン券が送付される。
#' 1. 2020年度は、47-52歳の男性にクーポン券が送付される。
#' 1. 2021年度は、53-56歳の男性にクーポン券が送付される。
#'
#' 2019-2020年度では、
...
#' 厚生労働省の集計データによると、
#' 2020年1月時点で、クーポン券を利用した抗体検査の受検率は約18%と低い水準にとどまった[^calc]。
#'
#' [^calc]: 2019年4月から2020年3月までに40歳から46歳の男性にクーポン券が発送された。
