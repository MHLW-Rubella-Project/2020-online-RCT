...
\begin{figure}
\centering
\includegraphics{C:/Users/vge00/Desktop/2020-online-RCT/assets/rubella-coupon.png}
\caption{\label{fig:coupon}Sample Coupon for Free Rubella Antibody Test and Vaccination}
\end{figure}
...
Fisher's exact test (p-value) &  & 0.83 & 0.76 &  & 0.13 & 0.32\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
