...
This argument is related with the targeting of interventions [e.g., @Finkelstein2019]. That is, the question is whether marginal individuals whose behavior is changed by intervention receive significant benefits from a policy. In our context, we suggest that the Altruistic message increases the number of negative individuals who receive a large benefit (vaccination) from the FY2019 vaccination campaign. Thus, the Altruistic message improves targeting. However, since we cannot test the difference in the ratio of negative antibody tests due to small sample, the experimental data in this study alone do not allow us to fully explore this argument, and this is a topic for future research.
