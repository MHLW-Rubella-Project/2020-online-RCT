...
\urlstyle{same}
\hypersetup{
  pdftitle={Supplementary Material ``Adding Nudge-based Reminders to Financial Incentives for Promoting Antibody Testing and Vaccination to Mitigate the Spread of Rubella''},
  hidelinks,
