...
Although men aged 40--46 years automatically received monetary incentives, the uptake rate of antibody testing with vouchers remained as low as 18\% as of January 2020.[^calc] Given adequate financial incentives, non-monetary interventions should be considered to increase antibody testing. Therefore, we developed reminders with behavioral science-based text messages for those who were not tested and vaccinated. Using a nationwide online survey, we tested how well those reminders improve antibody testing and vaccination rates among default voucher recipients (and the effect on those who incur a transaction cost to obtain them).
